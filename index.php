...
<body>
	<div class="wrapper container-fluid">
		...
		<div id="main" class="container">
							...
							<div class="block_picker col-lg-7 offset-lg-1 p-4 align-self-center">
								<div class="row ">	
									<div class="col-xs-4 col-sm-4 col-md-4">
										<input name="floor1" class="form-control mb-3" type="number" placeholder="Этаж" min="1" pattern="^[0-9]">
										<input name="floor2" class="form-control mb-3" type="number" placeholder="Этаж" min="1" pattern="^[0-9]">
										<input name="floor3" class="form-control mb-3" type="number" placeholder="Этаж" min="1" pattern="^[0-9]">
										<input name="floor4" class="form-control mb-3" type="number" placeholder="Этаж" min="1" pattern="^[0-9]">
									</div>
									<div class="col-xs-4 col-sm-4 col-md-4">
										<input name="area-size1" class="form-control mb-3" type="text" placeholder="Площадь" min="10" pattern="^[0-9]">
										<input name="area-size2" class="form-control mb-3" type="text" placeholder="Площадь" min="10" pattern="^[0-9]">
									</div>
									<div class="col-xs-4 col-sm-4 col-md-4">
										<input name="numberOfRoom1" class="form-control mb-3" type="text" placeholder="Кол-во комнат" min="1" pattern="^[0-9]">
										<input name="numberOfRoom2" class="form-control mb-3" type="text" placeholder="Кол-во комнат" min="1" pattern="^[0-9]">
									</div>
								</div>	
							</div>
						</div>
			...
			<section id="result">	
				<div class="container cost p-5">
					<div class="row">
						<div class="cost_container col-lg-4 m-auto text-center">
							<h2>AVERAGE SUM</h2>
							<p class="h1">$1000,00</p>
						</div>

						<table class="table col-lg-8 table-striped table-hover">
				...
				<div id="itemsContainer" class="result_container p-5 container">
					...
					<div class="items_container container p-4">
						<section>
