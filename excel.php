...
foreach ($objectArray as $cell) {
    ...
    $sheet->setCellValueByColumnAndRow(15, $startLine, $cell->tuilet);
    $sheet->setCellValueByColumnAndRow(16, $startLine, $cell->heating);
    $sheet->setCellValueByColumnAndRow(17, $startLine, $cell->repear);
